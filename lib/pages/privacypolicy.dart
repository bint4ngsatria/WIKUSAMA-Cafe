            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: subtitleSize, color: const Color(0xFF59422E)),
                ),
                SizedBox(height: 16),
                Text(
                  '1. User Data',
                  style: TextStyle(fontSize: subtitleSize, fontWeight: FontWeight.bold, color: const Color(0xFF59422E)),
                ),
                SizedBox(height: 8),
                Text(
